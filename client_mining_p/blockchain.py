...
class Blockchain(object):
    def __init__(self):
        ...
        self.new_block(previous_hash="Wizard of Oz.", proof=100)
...
def mine():
    ...
    res=blockchain.valid_proof(data['proof'])
...
def last_block():
    ...
    response={
        "last_block": blockchain.last_block #this returns what is returned from the method above
    }
    return jsonify(response), 200
